...
;; :UNSUPPORTED_TEST_CASE: Removed because preset test generator does not support parse failures. We assume the wasmtime parser is correct.
;; (assert_unlinkable
;;   (module
;;     (table 0 funcref)
;;     (func $f)
...
;; :DELTA_SPEC: Importing / exporting tables across modules is unsupported in this runtime
;; (module $module1
;;   (type $out-i32 (func (result i32)))
...
;; ;; :DELTA_SPEC: Trap are unsupported in this runtime
