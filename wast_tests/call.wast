...
(assert_return (invoke "even" (i64.const 30)) (i32.const 44)) ;; :MODIFIED: Modified reduced loop parameter due to small memory assigned to Aurix Context Saving area CSA
(assert_return (invoke "even" (i64.const 27)) (i32.const 99)) ;; :MODIFIED: Modified reduced loop parameter due to small memory assigned to Aurix Context Saving area CSA
(assert_return (invoke "odd" (i64.const 0)) (i32.const 99))
(assert_return (invoke "odd" (i64.const 1)) (i32.const 44))
(assert_return (invoke "odd" (i64.const 30)) (i32.const 99)) ;; :MODIFIED: Modified reduced loop parameter due to small memory assigned to Aurix Context Saving area CSA
(assert_return (invoke "odd" (i64.const 27)) (i32.const 44)) ;; :MODIFIED: Modified reduced loop parameter due to small memory assigned to Aurix Context Saving area CSA
