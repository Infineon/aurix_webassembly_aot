...
(assert_return (invoke "as-memory.grow-last" (i32.const 2)) (i32.const -1)) ;; :DELTA_SPEC: This function fails because it is not supported by this runtime result changed to -1
(assert_return (invoke "as-memory.grow-everywhere" (i32.const 12)) (i32.const -1)) ;; :DELTA_SPEC: This function fails because it is not supported by this runtime result changed to -1
