...
mod tests {
    ...
    fn init() -> WasmRuntime<'static> {
            ...
            let wasm_code = include_bytes!(concat!("../wasm_json_from_wast/", "f32.0.wasm"));
    ...
    fn test_116(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("add", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(3217031168 as u32)));
    }
    ...
    fn test_119(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("add", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(1069547520 as u32)));
    }
    ...
    fn test_120(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("add", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(3235450843 as u32)));
    }
    ...
    fn test_121(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("add", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(1085870043 as u32)));
    }
    ...
    fn test_122(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("add", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(3233353691 as u32)));
    }
    ...
    fn test_123(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("add", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(1087967195 as u32)));
    }
    ...
    fn test_160(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("add", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(3236499419 as u32)));
    }
    ...
    fn test_161(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("add", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(1084821467 as u32)));
    }
    ...
    fn test_162(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("add", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(3232305115 as u32)));
    }
    ...
    fn test_163(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("add", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(1089015771 as u32)));
    }
