...
mod tests {
    ...
    fn init() -> WasmRuntime<'static> {
            ...
            let wasm_code = include_bytes!(concat!("../wasm_json_from_wast/", "float_exprs.3.wasm"));
    ...
    fn test_0(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f32.no_fold_zero_sub", args, Some(ValueSize::Word));
    ...
    fn test_1(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f64.no_fold_zero_sub", args, Some(ValueSize::DoubleWord));
