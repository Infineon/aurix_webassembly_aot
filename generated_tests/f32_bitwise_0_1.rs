...
mod tests {
    ...
    fn init() -> WasmRuntime<'static> {
            ...
            let wasm_code = include_bytes!(concat!("../wasm_json_from_wast/", "f32_bitwise.0.wasm"));
    ...
    fn test_0(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("copysign", args, Some(ValueSize::Word));
    ...
    fn test_124(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("abs", args, Some(ValueSize::Word));
    ...
    fn test_142(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::Word(2147483648 as u32)];
        let result = runtime.call_exported_function("neg", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(0 as u32)));
    }
