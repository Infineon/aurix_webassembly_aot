...
mod tests {
    ...
    fn init() -> WasmRuntime<'static> {
            ...
            let wasm_code = include_bytes!(concat!("../wasm_json_from_wast/", "f64_bitwise.0.wasm"));
    ...
    fn test_124(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("abs", args, Some(ValueSize::DoubleWord));
    ...
    fn test_142(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775808 as u64)];
        let result = runtime.call_exported_function("neg", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(0 as u64)));
    }
