...
mod tests {
    ...
    fn init() -> WasmRuntime<'static> {
            ...
            let wasm_code = include_bytes!(concat!("../wasm_json_from_wast/", "f64.0.wasm"));
    ...
    fn test_61(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9223372036854775814 as u64)));
    }
    ...
    fn test_64(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(4382002437431492607 as u64)));
    }
    ...
    fn test_65(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(13605374474286268415 as u64)));
    }
    ...
    fn test_92(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2251799813685248 as u64)));
    }
    ...
    fn test_93(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9225623836668461056 as u64)));
    }
    ...
    fn test_100(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(16081437006769432 as u64)));
    }
    ...
    fn test_101(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9239453473861545240 as u64)));
    }
    ...
    fn test_104(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(4616189618054758399 as u64)));
    }
    ...
    fn test_105(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(13839561654909534207 as u64)));
    }
    ...
    fn test_132(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(4598175219545276416 as u64)));
    }
    ...
    fn test_133(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(13821547256400052224 as u64)));
    }
    ...
    fn test_140(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(4614256656552045848 as u64)));
    }
    ...
    fn test_141(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(13837628693406821656 as u64)));
    }
    ...
    fn test_144(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9214364837600034815 as u64)));
    }
    ...
    fn test_145(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(18437736874454810623 as u64)));
    }
