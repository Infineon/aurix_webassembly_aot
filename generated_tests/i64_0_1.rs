...
mod tests {
    ...
    fn test_0(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223512776490647552 as u64)];
        let result = runtime.call_exported_function("popcnt", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(4 as u64)));
    }
    ...
    fn test_2(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(12297829381041378645 as u64)];
        let result = runtime.call_exported_function("popcnt", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(32 as u64)));
    }
    ...
    fn test_3(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(11068046444512062122 as u64)];
        let result = runtime.call_exported_function("popcnt", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(32 as u64)));
    }
    ...
    fn test_4(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(16045690984833335023 as u64)];
        let result = runtime.call_exported_function("popcnt", args, Some(ValueSize::DoubleWord));
    ...
    fn test_22(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775808 as u64),Immediate::DoubleWord(9223372036854775807 as u64)];
        let result = runtime.call_exported_function("eq", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(0 as u32)));
    }
