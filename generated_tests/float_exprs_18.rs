...
mod tests {
    ...
    fn init() -> WasmRuntime<'static> {
            ...
            let wasm_code = include_bytes!(concat!("../wasm_json_from_wast/", "float_exprs.18.wasm"));
    ...
    fn test_0(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f32.no_distribute", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(4131116009 as u32)));
    }
    ...
    fn test_1(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f32.no_distribute", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(3095417248 as u32)));
    }
    ...
    fn test_2(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f32.no_distribute", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(3904015704 as u32)));
    }
    ...
    fn test_3(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f32.no_distribute", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(3679965351 as u32)));
    }
    ...
    fn test_4(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f32.no_distribute", args, Some(ValueSize::Word));
        assert_eq!(result, Some(Immediate::Word(649094374 as u32)));
    }
    ...
    fn test_5(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f64.no_distribute", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(10911876679403600667 as u64)));
    }
    ...
    fn test_7(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f64.no_distribute", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(5500432744005058079 as u64)));
    }
    ...
    fn test_8(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f64.no_distribute", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(11527035460272583043 as u64)));
    }
    ...
    fn test_9(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f64.no_distribute", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(13429277897969282898 as u64)));
    }
