...
mod tests {
    ...
    fn init() -> WasmRuntime<'static> {
            ...
            let wasm_code = include_bytes!(concat!("../wasm_json_from_wast/", "float_exprs.14.wasm"));
    ...
    fn test_0(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f32.no_fold_sub_self", args, Some(ValueSize::Word));
    ...
    fn test_2(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f64.no_fold_sub_self", args, Some(ValueSize::DoubleWord));
