...
mod tests {
    ...
    fn init() -> WasmRuntime<'static> {
            ...
            let wasm_code = include_bytes!(concat!("../wasm_json_from_wast/", "float_exprs.80.wasm"));
    ...
    fn test_0(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f32.compute_radix", args, Some(ValueSize::Word));
    ...
    fn test_1(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("f64.compute_radix", args, Some(ValueSize::DoubleWord));
