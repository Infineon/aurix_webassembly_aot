...
mod tests {
    ...
    fn test_49(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("sub", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9227875636482146305 as u64)));
    }
    ...
    fn test_50(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("sub", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(4503599627370497 as u64)));
    }
    ...
    fn test_51(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("sub", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9227875636482146303 as u64)));
    }
    ...
    fn test_137(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("sub", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(13832806255468478464 as u64)));
    }
    ...
    fn test_138(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("sub", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(4609434218613702656 as u64)));
    }
