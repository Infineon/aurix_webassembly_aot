...
mod tests {
    ...
    fn init() -> WasmRuntime<'static> {
            ...
            let wasm_code = include_bytes!(concat!("../wasm_json_from_wast/", "i64.0.wasm"));
    ...
    fn test_2(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551615 as u64),Immediate::DoubleWord(18446744073709551615 as u64)];
        let result = runtime.call_exported_function("add", args, Some(ValueSize::DoubleWord));
    ...
    fn test_3(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551615 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("add", args, Some(ValueSize::DoubleWord));
    ...
    fn test_4(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775807 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("add", args, Some(ValueSize::DoubleWord));
    ...
    fn test_5(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775808 as u64),Immediate::DoubleWord(18446744073709551615 as u64)];
        let result = runtime.call_exported_function("add", args, Some(ValueSize::DoubleWord));
    ...
    fn test_7(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1073741823 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("add", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(1073741824 as u64)));
    }
    ...
    fn test_11(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775807 as u64),Immediate::DoubleWord(18446744073709551615 as u64)];
        let result = runtime.call_exported_function("sub", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9223372036854775808 as u64)));
    }
    ...
    fn test_14(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1073741823 as u64),Immediate::DoubleWord(18446744073709551615 as u64)];
        let result = runtime.call_exported_function("sub", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(1073741824 as u64)));
    }
    ...
    fn test_15(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(1 as u64)));
    }
    ...
    fn test_18(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1152921504606846976 as u64),Immediate::DoubleWord(4096 as u64)];
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(0 as u64)));
    }
    ...
    fn test_22(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(81985529216486895 as u64),Immediate::DoubleWord(18364758544493064720 as u64)];
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2465395958572223728 as u64)));
    }
    ...
    fn test_23(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775807 as u64),Immediate::DoubleWord(9223372036854775807 as u64)];
        let result = runtime.call_exported_function("mul", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(1 as u64)));
    }
    ...
    fn test_24(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(1 as u64)));
    }
    ...
    fn test_26(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(0 as u64),Immediate::DoubleWord(18446744073709551615 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(0 as u64)));
    }
    ...
    fn test_28(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775808 as u64),Immediate::DoubleWord(2 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
    ...
    fn test_29(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775809 as u64),Immediate::DoubleWord(1000 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(18437520701672696841 as u64)));
    }
    ...
    fn test_30(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(5 as u64),Immediate::DoubleWord(2 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2 as u64)));
    }
    ...
    fn test_31(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551611 as u64),Immediate::DoubleWord(2 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(18446744073709551614 as u64)));
    }
    ...
    fn test_32(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(5 as u64),Immediate::DoubleWord(18446744073709551614 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(18446744073709551614 as u64)));
    }
    ...
    fn test_33(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551611 as u64),Immediate::DoubleWord(18446744073709551614 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2 as u64)));
    }
    ...
    fn test_34(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(7 as u64),Immediate::DoubleWord(3 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2 as u64)));
    }
    ...
    fn test_35(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551609 as u64),Immediate::DoubleWord(3 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(18446744073709551614 as u64)));
    }
    ...
    fn test_36(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(7 as u64),Immediate::DoubleWord(18446744073709551613 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(18446744073709551614 as u64)));
    }
    ...
    fn test_37(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551609 as u64),Immediate::DoubleWord(18446744073709551613 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2 as u64)));
    }
    ...
    fn test_38(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(11 as u64),Immediate::DoubleWord(5 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2 as u64)));
    }
    ...
    fn test_39(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(17 as u64),Immediate::DoubleWord(7 as u64)];
        let result = runtime.call_exported_function("div_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2 as u64)));
    }
    ...
    fn test_40(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("div_u", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(1 as u64)));
    }
    ...
    fn test_45(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(10371807465568210928 as u64),Immediate::DoubleWord(4294967297 as u64)];
        let result = runtime.call_exported_function("div_u", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2414874607 as u64)));
    }
    ...
    fn test_46(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775809 as u64),Immediate::DoubleWord(1000 as u64)];
        let result = runtime.call_exported_function("div_u", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9223372036854775 as u64)));
    }
    ...
    fn test_48(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551611 as u64),Immediate::DoubleWord(2 as u64)];
        let result = runtime.call_exported_function("div_u", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9223372036854775805 as u64)));
    }
    ...
    fn test_54(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775807 as u64),Immediate::DoubleWord(18446744073709551615 as u64)];
        let result = runtime.call_exported_function("rem_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(0 as u64)));
    }
    ...
    fn test_61(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775809 as u64),Immediate::DoubleWord(1000 as u64)];
        let result = runtime.call_exported_function("rem_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(18446744073709550809 as u64)));
    }
    ...
    fn test_72(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("rem_u", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(0 as u64)));
    }
    ...
    fn test_77(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(10371807465568210928 as u64),Immediate::DoubleWord(4294967297 as u64)];
        let result = runtime.call_exported_function("rem_u", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2147483649 as u64)));
    }
    ...
    fn test_78(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775809 as u64),Immediate::DoubleWord(1000 as u64)];
        let result = runtime.call_exported_function("rem_u", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(809 as u64)));
    }
    ...
    fn test_86(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(0 as u64)];
        let result = runtime.call_exported_function("and", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(0 as u64)));
    }
    ...
    fn test_90(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775807 as u64),Immediate::DoubleWord(9223372036854775808 as u64)];
        let result = runtime.call_exported_function("and", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(0 as u64)));
    }
    ...
    fn test_92(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(4042326015 as u64),Immediate::DoubleWord(4294963440 as u64)];
        let result = runtime.call_exported_function("and", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(4042322160 as u64)));
    }
    ...
    fn test_94(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(0 as u64)];
        let result = runtime.call_exported_function("or", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(1 as u64)));
    }
    ...
    fn test_102(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(0 as u64)];
        let result = runtime.call_exported_function("xor", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(1 as u64)));
    }
    ...
    fn test_108(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551615 as u64),Immediate::DoubleWord(9223372036854775808 as u64)];
        let result = runtime.call_exported_function("xor", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9223372036854775807 as u64)));
    }
    ...
    fn test_109(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551615 as u64),Immediate::DoubleWord(9223372036854775807 as u64)];
        let result = runtime.call_exported_function("xor", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9223372036854775808 as u64)));
    }
    ...
    fn test_110(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(4042326015 as u64),Immediate::DoubleWord(4294963440 as u64)];
        let result = runtime.call_exported_function("xor", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(252645135 as u64)));
    }
    ...
    fn test_112(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("shl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2 as u64)));
    }
    ...
    fn test_117(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(4611686018427387904 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("shl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9223372036854775808 as u64)));
    }
    ...
    fn test_118(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(63 as u64)];
        let result = runtime.call_exported_function("shl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9223372036854775808 as u64)));
    }
    ...
    fn test_119(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(64 as u64)];
        let result = runtime.call_exported_function("shl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(1 as u64)));
    }
    ...
    fn test_120(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(65 as u64)];
        let result = runtime.call_exported_function("shl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2 as u64)));
    }
    ...
    fn test_121(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(18446744073709551615 as u64)];
        let result = runtime.call_exported_function("shl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9223372036854775808 as u64)));
    }
    ...
    fn test_122(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(9223372036854775807 as u64)];
        let result = runtime.call_exported_function("shl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9223372036854775808 as u64)));
    }
    ...
    fn test_123(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("shr_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(0 as u64)));
    }
    ...
    fn test_126(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775807 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("shr_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(4611686018427387903 as u64)));
    }
    ...
    fn test_134(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(9223372036854775808 as u64),Immediate::DoubleWord(63 as u64)];
        let result = runtime.call_exported_function("shr_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(18446744073709551615 as u64)));
    }
    ...
    fn test_135(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551615 as u64),Immediate::DoubleWord(64 as u64)];
        let result = runtime.call_exported_function("shr_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(18446744073709551615 as u64)));
    }
    ...
    fn test_136(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551615 as u64),Immediate::DoubleWord(65 as u64)];
        let result = runtime.call_exported_function("shr_s", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(18446744073709551615 as u64)));
    }
    ...
    fn test_140(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("shr_u", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(0 as u64)));
    }
    ...
    fn test_157(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("rotl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(2 as u64)));
    }
    ...
    fn test_161(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(12379718583323101902 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("rotl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(6312693092936652189 as u64)));
    }
    ...
    fn test_162(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18302628889324683264 as u64),Immediate::DoubleWord(4 as u64)];
        let result = runtime.call_exported_function("rotl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(16140901123551657999 as u64)));
    }
    ...
    fn test_163(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(12379570969274382345 as u64),Immediate::DoubleWord(53 as u64)];
        let result = runtime.call_exported_function("rotl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(87109505680009935 as u64)));
    }
    ...
    fn test_164(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(12380715672649826460 as u64),Immediate::DoubleWord(63 as u64)];
        let result = runtime.call_exported_function("rotl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(6190357836324913230 as u64)));
    }
    ...
    fn test_165(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(12379570969274382345 as u64),Immediate::DoubleWord(245 as u64)];
        let result = runtime.call_exported_function("rotl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(87109505680009935 as u64)));
    }
    ...
    fn test_166(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(12379676934707509257 as u64),Immediate::DoubleWord(18446744073709551597 as u64)];
        let result = runtime.call_exported_function("rotl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(14916262237559758314 as u64)));
    }
    ...
    fn test_167(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(12380715672649826460 as u64),Immediate::DoubleWord(9223372036854775871 as u64)];
        let result = runtime.call_exported_function("rotl", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(6190357836324913230 as u64)));
    }
    ...
    fn test_170(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(1 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("rotr", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(9223372036854775808 as u64)));
    }
    ...
    fn test_174(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(12379718583323101902 as u64),Immediate::DoubleWord(1 as u64)];
        let result = runtime.call_exported_function("rotr", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(6189859291661550951 as u64)));
    }
    ...
    fn test_175(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18302628889324683264 as u64),Immediate::DoubleWord(4 as u64)];
        let result = runtime.call_exported_function("rotr", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(1143914305582792704 as u64)));
    }
    ...
    fn test_176(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(12379570969274382345 as u64),Immediate::DoubleWord(53 as u64)];
        let result = runtime.call_exported_function("rotr", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(7534987797011123550 as u64)));
    }
    ...
    fn test_177(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(12380715672649826460 as u64),Immediate::DoubleWord(63 as u64)];
        let result = runtime.call_exported_function("rotr", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(6314687271590101305 as u64)));
    }
    ...
    fn test_179(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(12379676934707509257 as u64),Immediate::DoubleWord(18446744073709551597 as u64)];
        let result = runtime.call_exported_function("rotr", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(10711665151168044651 as u64)));
    }
    ...
    fn test_183(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("clz", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(0 as u64)));
    }
    ...
    fn test_185(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(32768 as u64)];
        let result = runtime.call_exported_function("clz", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(48 as u64)));
    }
    ...
    fn test_186(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(255 as u64)];
        let result = runtime.call_exported_function("clz", args, Some(ValueSize::DoubleWord));
    ...
    fn test_188(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("clz", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(63 as u64)));
    }
    ...
    fn test_189(runtime : &mut WasmRuntime<'static>){
        ...
        let result = runtime.call_exported_function("clz", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(62 as u64)));
    }
    ...
    fn test_191(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551615 as u64)];
        let result = runtime.call_exported_function("ctz", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(0 as u64)));
    }
    ...
    fn test_193(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(32768 as u64)];
        let result = runtime.call_exported_function("ctz", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(15 as u64)));
    }
    ...
    fn test_194(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(65536 as u64)];
        let result = runtime.call_exported_function("ctz", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(16 as u64)));
    }
    ...
    fn test_197(runtime : &mut WasmRuntime<'static>){
        let args = vec![Immediate::DoubleWord(18446744073709551615 as u64)];
        let result = runtime.call_exported_function("popcnt", args, Some(ValueSize::DoubleWord));
        assert_eq!(result, Some(Immediate::DoubleWord(64 as u64)));
    }
