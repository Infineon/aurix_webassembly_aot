...
pub struct WasmRuntime<'a> {
    ...
    pub linear_memory: &'a mut [u8], // linear memory of the wasm module
    pub global_space: &'a mut [u8], // memory space to store global variables (as well as the linear memory size)
    ...
    pub export_map: IndexMap<String, u32, FnvBuildHasher>, // maps name of each exported function to its index in function_labels
